...
const (
	GophKeeperPrivateService_TextCreate_FullMethodName = "/grpc.GophKeeperPrivateService/TextCreate"
)
...
type GophKeeperPrivateServiceClient interface {
	TextCreate(ctx context.Context, in *TextCreateRequest, opts ...grpc.CallOption) (*CreateResponse, error)
}
...
func (c *gophKeeperPrivateServiceClient) TextCreate(ctx context.Context, in *TextCreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateResponse)
	err := c.cc.Invoke(ctx, GophKeeperPrivateService_TextCreate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GophKeeperPrivateServiceServer interface {
	TextCreate(context.Context, *TextCreateRequest) (*CreateResponse, error)
...
func (UnimplementedGophKeeperPrivateServiceServer) TextCreate(context.Context, *TextCreateRequest) (*CreateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TextCreate not implemented")
}
...
func _GophKeeperPrivateService_TextCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TextCreateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GophKeeperPrivateServiceServer).TextCreate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GophKeeperPrivateService_TextCreate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GophKeeperPrivateServiceServer).TextCreate(ctx, req.(*TextCreateRequest))
	}
...
var GophKeeperPrivateService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "TextCreate",
			Handler:    _GophKeeperPrivateService_TextCreate_Handler,
		},
	},
